...
## Load data and make trainig & test sets
...
#### Ensembles with `caretEnsemble`

1) Build an ensemble with the best low correlated models:
...
summary(greedy_ensemble$ens_model$finalModel)
```
